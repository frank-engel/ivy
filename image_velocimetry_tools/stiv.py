...
def extract_space_time_image(
    ...
    x1, y1 = polar_to_cartesian(np.deg2rad(search_angle_arithmetic),
                                num_pixels, isImage=True)
    ...
    coordinates = np.column_stack((yi_repeat, xi_repeat, frame_indices_repeat))
...
def two_dimensional_stiv_exhaustive(
    ...
    **kwargs : optional keyword arguments
    ...
    if sti_format == 'normalized':
        ...
        raise ValueError(f"Unknown sti_format: {sti_format}. "
